...
#endif
{
	...
	public void UpdateIsUserDefinedSoundBank()
	{
		...
		{
			WwiseSoundBankRef soundBankRef = new WwiseSoundBankRef(DisplayName);
			if (IsInUserDefinedSoundBank != soundBankRef.IsUserBank && soundBankRef.IsValid)
			{
				IsInUserDefinedSoundBank = soundBankRef.IsUserBank;
	...
	public void UnloadAutoBank()
	{
		...
		{
#if AK_WWISE_ADDRESSABLES && UNITY_ADDRESSABLES
			AkAddressableBankManager.Instance.UnloadBank(AutoBank);
#else
