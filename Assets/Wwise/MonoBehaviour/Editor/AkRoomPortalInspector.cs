		...
		if (AkWwiseEditorSettings.Instance.ShowSpatialAudioWarningMsg)
		{
			if (!portal.IsValid)
			{
				...
				UnityEditor.EditorGUILayout.HelpBox(
					"Portal placement is invalid. It will not be set in the Spatial Audio engine. The front and back Rooms of the Portal cannot be the same or be part of the same Reverb Zone hierarchy.",
