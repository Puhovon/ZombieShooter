...
public class AkRoomInspector : UnityEditor.Editor
{
	...
	private UnityEditor.SerializedProperty enableReverbZone;
	private UnityEditor.SerializedProperty parentRoom;
	private UnityEditor.SerializedProperty transitionRegionWidth;
	...
	private void OnEnable()
	{
		...
		enableReverbZone = serializedObject.FindProperty("enableReverbZone");
		parentRoom = serializedObject.FindProperty("parentRoom");
		transitionRegionWidth = serializedObject.FindProperty("transitionRegionWidth");
	}
	...
	public override void OnInspectorGUI()
	{
		...
		UnityEditor.EditorGUILayout.LabelField("Room Reverb", UnityEditor.EditorStyles.boldLabel);
		using (new UnityEditor.EditorGUILayout.VerticalScope("box"))
		{
		...
		UnityEditor.EditorGUILayout.LabelField("Reverb Zone", UnityEditor.EditorStyles.boldLabel);
		using (new UnityEditor.EditorGUILayout.VerticalScope("box"))
		{
			UnityEditor.EditorGUILayout.PropertyField(enableReverbZone);
			if (enableReverbZone.boolValue)
			{
				UnityEditor.EditorGUILayout.PropertyField(parentRoom);
				UnityEditor.EditorGUILayout.PropertyField(transitionRegionWidth);
			}
		}
