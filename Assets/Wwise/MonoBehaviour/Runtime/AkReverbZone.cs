...
[System.Obsolete(AkUnitySoundEngine.Deprecation_2023_1_2)]
...
public class AkReverbZone : UnityEngine.MonoBehaviour
{
	...
	private void Awake()
	{
		if (ReverbZone != null)
		{
			ReverbZone.enableReverbZone = true;
			ReverbZone.parentRoom = ParentRoom;
			ReverbZone.transitionRegionWidth = TransitionRegionWidth;
		}
	}
}
